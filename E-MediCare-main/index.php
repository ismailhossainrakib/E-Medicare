...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp E-MediCare: A Modern Hospital Management Solution</h4></a>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        ...
                        <h3>Welcome to E-MediCare!</h3>
                         <P>A smart, modern solution to streamline hospital operations and improve patient care.
                            E-MediCare empowers healthcare professionals and connects patients with efficient, tech-driven services.</p>
